...
function CityChange() {
    ...
    var City = $("#City").val();
    if (City.trim() == "Bangalore") {
        $('#Div_Bangalore').show();
        $('#Div_Others').hide();
    }
    else if (City.trim() == "Others") {
        $('#Div_Bangalore').hide();
        $('#Div_Others').show();
    }
    else {
...
function validateExp() {
    ...
    if (PreferredLanguage == "0") {
        $('#spnPreferredLanguage').text('Please select your preferred language')
        IsValid = false;
    }
    else {
        $('#spnPreferredLanguage').text('');
    }

    var DoingUpFor = document.getElementById("DoingUpFor").value;
    if (DoingUpFor == "0") {
        $('#spnDoingUpFor').text('Please select one option');
        IsValid = false;
    }
    else {
        $('#spnDoingUpFor').text('');
    ...
    var DoingInteriorsFor = document.getElementById("DoingInteriorsFor").value;
    if (DoingInteriorsFor == "0") {
        $('#spnDoingInteriorsFor').text('Please select one option');
        IsValid = false;
    }
    else {
        $('#spnDoingInteriorsFor').text('');
    }
    }
    ...
    var DoingUpFor = $('#DoingUpFor').val();
    var DoingInteriorsFor = $('#DoingInteriorsFor').val();
    var PageType = $('#hdnPageFlag').val();
    ...
    var postData = {
        ...
        DoingUpFor: DoingUpFor,
        DoingInteriorsFor: DoingInteriorsFor,
        PageType: PageType,
    };
